...
This is the first time I think and write an yearly review. I am sure that there is plenty of better ways of doing it, but given that I wanted to start light-weight I simply tried to answer to some of the questions mentioned in [this Tweet](https://twitter.com/GergelyOrosz/status/1473905325526994944/photo/1). I either listed the relevant points to mention as individual paragraphs, either through bullet points. Sorry for the lack of consistency, hopefully it doesn't have a big impact in readability.


## What did I expect for 2021 VS what happened
When Covid-19 began I was working as a ML engineer for a seed-stage start-up looking for its product-market fit in the travel sector. This may already give an idea of how low my expectations were for 2021. This was particularly so also because I started the year in being furlough.

Despite the uncertainty, I ended up sticking with the start-up, mainly because I believed in the product and the CEO. This belief ended up being grounded, given that the start-up got acquired by a data provider called [Cirium](https://www.cirium.com/) in March.

During the first quarter of 2021 I also did a bunch of interviews. Which resulted in a couple of interesting offers, as well as a couple of nasty rejections. Doing a relatively large number of interviews, and receiving a healthy number of rejections I started thinking of interviews as opportunities to discover some areas of knowledge in which I am weak, as well as a way to get exposed to different interview questions and styles.
